...
<form method="post" enctype="multipart/form-data" action="/houseroom/save">
    <table>
        ...
        <tr><td>Количество комнат</td><td><input type="number" name="rooms" size="1" step="1" min="1" max="9" value="${houseroom.rooms?ifExists}"/></td></tr>
...
<form method="post" enctype="multipart/form-data" action="/houseroom/save">
    <table>
        ...
        <tr><td>Количество комнат</td><td><input type="number" name="rooms" size="1" step="1" min="1" max="9"/></td></tr>
