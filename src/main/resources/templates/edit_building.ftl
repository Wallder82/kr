    ...
    <#if building??>
        <form method="post" enctype="multipart/form-data" action="/building/save">
            <table>
                ...
                <tr><td>Площадь земельного участка. Метры</td><td><input type="number" name="land" size="12" step="0.01" min="0.01" value="${building.land?ifExists}"/>${building.land?ifExists}</td></tr>
                <tr><td>Год постройки здания</td><td><input type="number" name="constructionYear" size="4" step="1" min="1" value="${building.constructionYear?ifExists}"/></td></tr>
                ...
                <tr><td>Площадь квартир. Метры</td><td><input type="number" name="square" size="12" step="0.01" min="0.01" value="${building.square?ifExists}"/></td></tr>
                <tr><td>Количество квартир в здании</td><td><input type="number" name="flats" size="3" step="1" min="1" value="${building.flats?ifExists}"/></td></tr>
